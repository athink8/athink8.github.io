...
cover: false
top: false
keywords: 'logback,日志,Java,11,11分钟,blog.onfree.cn,Athink'
summary: >-
  Logback 的架构非常通用，适用不同的使用场景。Logback
  被分成三个不同的模块：logback-core，logback-classic，logback-access。
abbrlink: 19d5fc10
date: 2020-03-17 14:40:00
---
