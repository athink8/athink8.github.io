...
cover: false
top: false
keywords: 'Eclipse,快捷键,博客,11分钟,11,blog.onfree.cn,Athink'
summary: 很多人一开始学习开发时，都是使用Eclipse 来开发，然后肯定因为种种原因需要切换到Idea上；而快捷键是必不可少且是快捷开发
abbrlink: 58d9ea91
...
很多人一开始学习开发时，都是使用Eclipse 来开发，然后肯定因为种种原因需要切换到Idea上；

而快捷键是必不可少且是快捷开发的途径之一，切换开发工具后，使用同一套快捷键可以减少重新学习工具的快捷键。
